...
allowed-tools:
  ...
  - AskUserQuestion
---
<!-- Forked from garrytan/gstack review v1.0.0 — update check and Greptile integration removed (standalone fork) -->
...
1. **Pass 1 (CRITICAL):** Items marked Critical in the checklist
2. **Pass 2 (INFORMATIONAL):** Remaining checklist items
